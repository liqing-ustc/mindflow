...
### Step 3：读取 Domain-Map

用 Read 读取 `Domain-Map/_index.md`，找到与 `section` 和 `sources` 相关的 domain，再读取对应的 `Domain-Map/{Name}.md`。
...
3. Read `Domain-Map/_index.md` → `Domain-Map/VLN.md`，了解 Established Knowledge 和 Active Debates
